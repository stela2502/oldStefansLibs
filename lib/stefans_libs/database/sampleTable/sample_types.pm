...
sub new {
	...
	bless $self, $class if ( $class eq "sample_types" );
...
sub addInitialDataset {
	my ($self) = @_;
	$self->AddDataset( { 'name' => 'tissue' } );
	$self->AddDataset( { 'name' => 'DNA' } );
	$self->AddDataset( { 'name' => 'mRNA' } );
	$self->AddDataset( { 'name' => 'sRNA' } );
	$self->AddDataset( { 'name' => 'linkerRNA' } );
	$self->AddDataset( { 'name' => 'protein' } );
