package stefans_libs_database_Contacts_address;
...
sub new {
    ...
    bless $self, $class if ( $class eq "stefans_libs_database_Contacts_address" );
...
sub  init_tableStructure {
     ...
     $self->{'Group_to_MD5_hash'} = [ 'street', 'house_number','post_number', 'city', 'type',]; # define which values should be grouped to get the 'md5_sum' entry
