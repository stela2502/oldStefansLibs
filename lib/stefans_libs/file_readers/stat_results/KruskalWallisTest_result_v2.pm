package stefans_libs_file_readers_stat_results_KruskalWallisTest_result_v2;
...
use base ('stefans_libs::file_readers::stat_results::KruskalWallisTest_result');
...
stefans_libs_file_readers_stat_results_KruskalWallisTest_result_v2
...
new returns a new object reference of the class stefans_libs_file_readers_stat_results_KruskalWallisTest_result_v2.
...
sub After_Data_read {
	...
	my @add = ('Probe Set ID', 'Gene Symbol','p-value','chi-squared');
